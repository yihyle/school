...
(1, 'Spring Boot 소개 및 설치', 'https://www.youtube.com/embed/9SGDpanrc8U', 600, 1, TRUE),
(1, 'Spring Initializr로 프로젝트 생성', 'https://www.youtube.com/embed/vtPkZShrvXQ', 720, 2, FALSE),
(1, 'application.yml 설정 이해하기', 'https://www.youtube.com/embed/vtPkZShrvXQ', 540, 3, FALSE);

-- Lectures for Course 1, Section 2
INSERT INTO lecture (section_id, title, video_url, duration, sort_order, is_preview) VALUES
(2, '@RestController와 @GetMapping 이해', 'https://www.youtube.com/embed/9SGDpanrc8U', 900, 1, FALSE),
(2, 'Request 파라미터 처리하기', 'https://www.youtube.com/embed/vtPkZShrvXQ', 840, 2, FALSE),
(2, '예외 처리와 GlobalExceptionHandler', 'https://www.youtube.com/embed/9SGDpanrc8U', 960, 3, FALSE);

-- Lectures for Course 1, Section 3
INSERT INTO lecture (section_id, title, video_url, duration, sort_order, is_preview) VALUES
(3, 'JPA Entity 설계', 'https://www.youtube.com/embed/9SGDpanrc8U', 1020, 1, FALSE),
(3, 'Repository와 JPQL 작성', 'https://www.youtube.com/embed/vtPkZShrvXQ', 900, 2, FALSE),
(3, '연관관계 매핑 실습', 'https://www.youtube.com/embed/9SGDpanrc8U', 1080, 3, FALSE);
...
INSERT INTO lecture (section_id, title, video_url, duration, sort_order, is_preview) VALUES
(4, 'React 18 새로운 기능', 'https://www.youtube.com/embed/vtPkZShrvXQ', 780, 1, TRUE),
(4, 'JSX와 컴포넌트 이해', 'https://www.youtube.com/embed/9SGDpanrc8U', 660, 2, FALSE),
(4, 'Hook: useState와 useEffect', 'https://www.youtube.com/embed/vtPkZShrvXQ', 900, 3, FALSE);

-- Lectures for Course 2, Section 5
INSERT INTO lecture (section_id, title, video_url, duration, sort_order, is_preview) VALUES
(5, 'Context API로 전역 상태 관리', 'https://www.youtube.com/embed/9SGDpanrc8U', 840, 1, FALSE),
(5, 'Redux Toolkit 입문', 'https://www.youtube.com/embed/vtPkZShrvXQ', 1020, 2, FALSE);
...
INSERT INTO lecture (section_id, title, video_url, duration, sort_order, is_preview) VALUES
(6, 'Docker 개념과 설치', 'https://www.youtube.com/embed/9SGDpanrc8U', 720, 1, TRUE),
(6, 'Dockerfile 작성법', 'https://www.youtube.com/embed/vtPkZShrvXQ', 840, 2, FALSE),
(6, 'Docker Compose 실습', 'https://www.youtube.com/embed/9SGDpanrc8U', 960, 3, FALSE);

-- Lectures for Course 3, Section 7
INSERT INTO lecture (section_id, title, video_url, duration, sort_order, is_preview) VALUES
(7, 'Kubernetes 아키텍처 이해', 'https://www.youtube.com/embed/vtPkZShrvXQ', 900, 1, FALSE),
(7, 'Pod와 Deployment 생성', 'https://www.youtube.com/embed/9SGDpanrc8U', 1080, 2, FALSE);
